                ...
                for (BlockState holder : world.getChunkAt(x, z).getTileEntities()) {
                    ...
                    if (onIsland(holder.getLocation())) {
                        if (holder.getType() == material) {
                            ...
                            if (holder.getType().equals(Material.LEGACY_BURNING_FURNACE)) {
                                result++;
                            }
                        ...
                        } else if (material.equals(Material.WALL_SIGN) || material.equals(Material.LEGACY_SIGN_POST)) {
                            if (holder.getType().equals(Material.WALL_SIGN) || holder.getType().equals(Material.LEGACY_SIGN_POST)) {
                                result++;
                            }
                        }
                    }
